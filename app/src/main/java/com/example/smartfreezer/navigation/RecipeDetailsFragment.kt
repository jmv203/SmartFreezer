    ...
    class RecipeDetailsFragment : Fragment() {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            binding.fabSaveRecipeDetails.setOnClickListener {
                recipeDetails?.id?.let { recipeId ->
                    saveRecipe(recipeId)
                }
            }
        ...
        private fun saveRecipe(recipeId: Int) {
            ...
            if (isRecipeSaved) {
                ...
                // Guardar la receta
                val data = hashMapOf("id" to recipeId)
        ...
        private fun checkSavedStatus() {
            ...
            savedRecipeRef.get()
                .addOnSuccessListener { document ->
                    isRecipeSaved = document.exists()
                    binding.fabSaveRecipeDetails.isSelected = isRecipeSaved
                }
                .addOnFailureListener {
